...
def sales_prices(item_and_price):
    ...
    for x in item_or_price:
        # Check if the element "x" contains letters
        if x.isalpha():
    ...
    return "The price of the {} is ${}.".format(item, price)

# Call to the function 
print(sales_prices("Winter fleece jackets 49.99"))
# Should print "The price of the Winter fleece jackets is $49.99."
...
# Call to the function
print(data_field_length("Catalog item 3523: Organic raw pumpkin seeds in shell"))
# Should print 9

# Skill 2: Using list method
...
def record_profit_years(recent_first, recent_last):
    # Reverse the order of the "recent_first" list so that the most recent year is last.
...
# 1- Use a list comprehension [ ] as a shortcut for creating a new list from a range.
# 2- Include a calculation with a for loop in a range with 2 parameters (lower, upper+1). 
...
# 1- Iterate through the keys and values of a dictionary.

#2- Return the keys and values in a formatted string using the .format() function.
...
# Skill 5: 
# Create a copy of a dictionary. Iterate through the values of the new dictionary.
# 
