...
# whether the word is read from left to right or right to left. Examples of palindromes are words like kayak 
# and radar, and phrases like "Never Odd or Even". 
...
def is_palindrome(input_string):
    ...
    for character in input_string:
        ...
        if character != " ":
            ...
            # If True, add the "character" to the end of "new_string" and
            # to the front of "reverse_string".
...
print(nametag("Jane", "Smith")) # Should be: Jane S.
...
# 
# Question 5
# The replace_ending function replaces a specified substring at the 
# end of a given sentence with a new substring. 
...
def replace_ending(sentence, old, new):
    # Check if the sentence ends with the old substring
    if sentence.endswith(old):
        ...
        return new_sentence 
    # If the sentence does not end with the old substring,
